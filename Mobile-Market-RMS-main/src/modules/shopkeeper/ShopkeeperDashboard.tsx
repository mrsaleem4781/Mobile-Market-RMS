...
export default function ShopkeeperDashboard({ currentUser, activeTab }: ShopkeeperDashboardProps) {
        ...
        <div className="bg-gradient-to-r from-rose-500 to-rose-700 text-white p-6 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-rose-100 leading-normal max-w-xl">
              Record stolen or snatched phones in the shared registry so shopkeepers can see alerts before buying or selling a device.
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              {reportedMobilesList.length === 0 ? (
                <div className="p-8 text-center text-slate-400 font-mono text-xs">
                  No active reports yet. When a stolen or snatched phone is reported, it will appear here for quick market awareness.
                </div>
              ) : (
  ...
  return (
    <div className="space-y-6" id="ops-scope">
      ...
      {/* Professional daily workflow guide */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3" id="shopkeeper-workflow-strip">
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs">
          <span className="text-[10px] font-black text-blue-600 font-mono uppercase tracking-wider">Step 01</span>
          <h3 className="text-sm font-extrabold text-slate-900 mt-1">Verify IMEI First</h3>
          <p className="text-[11px] text-slate-500 leading-relaxed mt-1">Har phone buy/sell se pehle IMEI status check karein.</p>
        </div>
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs">
          <span className="text-[10px] font-black text-emerald-600 font-mono uppercase tracking-wider">Step 02</span>
          <h3 className="text-sm font-extrabold text-slate-900 mt-1">Add Trade Entry</h3>
          <p className="text-[11px] text-slate-500 leading-relaxed mt-1">Buyer/seller CNIC, contact aur phone details complete save karein.</p>
        </div>
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-xs">
          <span className="text-[10px] font-black text-rose-600 font-mono uppercase tracking-wider">Step 03</span>
          <h3 className="text-sm font-extrabold text-slate-900 mt-1">Report Suspicious Device</h3>
          <p className="text-[11px] text-slate-500 leading-relaxed mt-1">Snatched/stolen match milay to registry me report update karein.</p>
        </div>
      </div>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 shadow-xs space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          <span className="text-[10px] text-slate-500 font-bold font-mono uppercase">Sample verification checks:</span>
          <button
          ...
          <div className="p-4 bg-emerald-50 border-2 border-emerald-250 rounded-xl flex items-start gap-3.5 shadow-xs transition duration-200 animate-fadeIn" id="verify-clean-alert">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-emerald-700 font-medium leading-relaxed">
                This IMEI is clean in the current registry. No active theft, snatching, or blocking complaint is found. You may continue the trade after verifying the customer CNIC and phone condition.
              </p>
          ...
          <div className="p-4 bg-rose-50 border-2 border-rose-250 rounded-xl flex items-start gap-3.5 shadow-xs transition duration-200 animate-pulse" id="verify-stolen-alert">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-rose-700 font-semibold leading-relaxed">
                This IMEI is registered in the blacklisted/stolen database. Stop the trade, keep the customer details, and report this match to the market president/admin or nearest CPLC/police authority.
              </p>
          ...
          <div className="p-4 bg-amber-50 border-2 border-amber-350 rounded-xl flex items-start gap-3.5 shadow-xs transition duration-200" id="verify-exists-alert">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-amber-700 font-medium leading-relaxed">
                This IMEI already exists in the internal shop registry. Please verify the previous entry before buying or selling the device again.
              </p>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xs" id="recent-listings">
        ...
        {filteredTransactions.length === 0 ? (
          <div className="p-8 text-center text-slate-400 text-sm font-mono leading-relaxed bg-white">
            {searchQuery ? "No entries match your search query." : "No trade entries yet. Start by verifying an IMEI, then add the first buy/sell record."}
          </div>
        ) : (
          ...
          <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl p-6 space-y-4" id="modal-box">
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <h3 className="text-sm font-semibold text-slate-800 flex items-center gap-1.5 uppercase font-mono">
                <ShieldCheck className="w-5 h-5 text-blue-600" /> New Buy/Sell Trade Entry
              </h3>
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3">
                <span className="text-[9px] text-blue-600 font-black font-mono uppercase">1. Device</span>
                <p className="text-[11px] text-slate-600 font-semibold mt-0.5">Model aur IMEI enter karein.</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3">
                <span className="text-[9px] text-emerald-600 font-black font-mono uppercase">2. Customer</span>
                <p className="text-[11px] text-slate-600 font-semibold mt-0.5">Buyer/seller identity complete karein.</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3">
                <span className="text-[9px] text-amber-600 font-black font-mono uppercase">3. Submit</span>
                <p className="text-[11px] text-slate-600 font-semibold mt-0.5">Entry local save aur sync queue me jayegi.</p>
              </div>
            </div>
