...
import { Transaction, SyncQueueItem, AuditLog, Shop, Market, AppUser, ReportedMobile, PublicNotice } from '../types';
...
export class MobileMarketDB extends Dexie {
  ...
  publicNotices!: Table<PublicNotice, string>;
  ...
  constructor() {
    ...
    this.version(2).stores({
      ...
      publicNotices: 'id, category, status, createdAt, createdBy, isPinned',
      config: 'key'
    });
  }
